...
TERMS: dict[str, tuple[str, str]] = {
    ...
    "邊緣鈣化": ("影像特徵", r"rim calcification|eggshell|peripheral calcification|蛋殼樣|邊緣鈣化"),
    "彗星尾偽影": ("影像特徵", r"comet[- ]tail|彗星尾|reverberation artifact"),
    "暈環": ("影像特徵", r"\bhalo\b|暈環|halo sign"),
    "甲狀腺外侵犯": ("影像特徵", r"extrathyroidal extension|\bete\b|甲狀腺外侵犯|capsular contact|包膜接觸"),
    ...
    "無痛性甲狀腺炎": ("疾病", r"painless thyroiditis|silent thyroiditis|無痛性甲狀腺炎|產後甲狀腺炎|postpartum thyroiditis"),
    "急性化膿性甲狀腺炎": ("疾病", r"suppurative thyroiditis|化膿性甲狀腺炎|thyroid abscess|甲狀腺膿瘍"),
    "Riedel 甲狀腺炎": ("疾病", r"riedel"),
    "IgG4 相關疾病": ("疾病", r"igg4"),
    "藥物相關甲狀腺病變": ("疾病", r"amiodarone|checkpoint inhibitor|immune[- ]related thyroiditis|藥物相關甲狀腺"),
    "乳突癌": ("疾病", r"papillary thyroid|\bptc\b|乳突癌|乳頭狀癌"),
    "濾泡癌": ("疾病", r"follicular thyroid carcinoma|\bftc\b|濾泡癌|follicular neoplasm|濾泡性腫瘤"),
    ...
    "甲狀腺轉移癌": ("疾病", r"metastas[ei]s to the thyroid|metastatic tumor to thyroid|甲狀腺轉移"),
    "瀰漫硬化型": ("疾病", r"diffuse sclerosing|瀰漫硬化"),
    "多結節性甲狀腺腫": ("疾病", r"multinodular goiter|\bmng\b|多結節|甲狀腺腫大"),
    "副甲狀腺腺瘤": ("疾病", r"parathyroid adenoma|副甲狀腺腺瘤|parathyroid hyperplasia|副甲狀腺增生"),
    ...
    "帶狀肌與頸長肌": ("解剖與分區", r"strap muscle|longus colli|帶狀肌|頸長肌|sternocleidomastoid|胸鎖乳突肌"),
    "喉返神經": ("解剖與分區", r"recurrent laryngeal|喉返神經|\brln\b"),
    "中央區": ("解剖與分區", r"central compartment|level vi|level 6|中央區|中央淋巴"),
    "側頸分區": ("解剖與分區", r"lateral neck|level ii|level iii|level iv|level v|側頸|頸部分區|neck level"),
    ...
    "熱消融": ("處置與介入", r"radiofrequency ablation|\brfa\b|microwave ablation|laser ablation|熱消融|射頻"),
    "酒精注射": ("處置與介入", r"ethanol ablation|\bpei\b|酒精注射|酒精消融"),
    "主動監測": ("處置與介入", r"active surveillance|主動監測|積極監測"),
    "檢體適足性": ("處置與介入", r"specimen adequacy|nondiagnostic|檢體適足|\brose\b|rapid on[- ]site"),
    ...
    "機器參數最佳化": ("技術", r"gain|dynamic range|\bfocus\b|frequency|\bprf\b|wall filter|參數|機器設定|preset"),
    "複合與諧波成像": ("技術", r"compound imaging|harmonic imaging|複合成像|諧波"),
    "人工智慧": ("技術", r"artificial intelligence|deep learning|machine learning|人工智慧|深度學習|radiomics|影像組學"),
